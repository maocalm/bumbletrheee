...
public class My3dRotateView extends ViewGroup  {
    ...
    private float animateTime =25000;//默认的动画持续时间
...
//        mGesture = new GestureDetector(context, this);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mChildCount; i++) {
            ...
            Log.e(TAG, "onDraw: x y " +x +"   "+y );
            RectF rectF = new RectF(mWidth / 2 - x - mChildWidth / 2, mHeight / 2 - y - mChildHeight / 2, mWidth / 2 - x + mChildWidth / 2, mHeight / 2 - y + mChildHeight / 2);
            canvas.drawCircle(rectF.centerX(), rectF.centerY(), 50, mPaint);
        }
